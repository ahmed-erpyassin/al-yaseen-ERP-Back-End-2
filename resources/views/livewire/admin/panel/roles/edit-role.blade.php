...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if ($guard_name) {
                const $guardNameSelector = document.querySelector("#guard_name");
                const $guardNameSelectInstance = mdb.Select.getInstance($guardNameSelector);
                $guardNameSelectInstance.setValue($guard_name);
            }
        });
    </script>
@endpush
