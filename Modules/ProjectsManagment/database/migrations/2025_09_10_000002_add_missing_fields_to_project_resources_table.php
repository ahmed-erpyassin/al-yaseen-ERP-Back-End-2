...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('project_resources', function (Blueprint $table) {
            ...
            // Add supplier number field (for display purposes)
            $table->string('supplier_number')->nullable()->after('supplier_id')->comment('Supplier number for display');
            
            // Add supplier name field (for display purposes)
            $table->string('supplier_name')->nullable()->after('supplier_number')->comment('Supplier name for display');
            
            // Add project number field (for display purposes)
            $table->string('project_number')->nullable()->after('supplier_name')->comment('Project number for display');
            
            // Add project name field (for display purposes)
