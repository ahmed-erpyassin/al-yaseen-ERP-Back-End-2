...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('manufacturing_processes', function (Blueprint $table) {
            ...
            $table->string('manufacturing_formula_number')->nullable();
            $table->string('manufacturing_formula_name')->nullable();
            ...
            $table->string('raw_materials_warehouse_name')->nullable();
            $table->string('finished_product_warehouse_name')->nullable();
