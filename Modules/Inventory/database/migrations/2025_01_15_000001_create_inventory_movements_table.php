...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inventory_movements', function (Blueprint $table) {
            ...
            $table->string('inbound_invoice_number')->nullable(); // Store number if table doesn't exist
            $table->string('outbound_invoice_number')->nullable(); // Store number if table doesn't exist
